...
headers = {
    ...
    # Miscellaneous
    'Referer': 'https://www.douyu.com/1126960',
    # Scurity
...
def get_video_flow(room_id=None, time_num=None):
    u" 获取直播视频流 "
    import os
    #groupListiframe = 1445245
    room_id = '1126960'
    val = 'r2h8YKuHh'
    room_id = '5429365'
    val = 'rGNdAQOv7'
    ...
    url = "https://p2ptest1.p2p.liveplay.myqcloud.com/video/%s%s/info/v_%s%s_%s.m4s"%(room_id,val,room_id,val,time_num)
    # 下载m4s视频流
...
def get_video_flv(room_id=None):
    room_id = '5429365'
    val = 'rGNdAQOv7'
    headers = {
        ...
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36',
        'Accept': '*/*',
        'Referer': 'https://www.douyu.com/5429365',
        'Accept-Encoding': 'gzip, deflate, br',
        'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8',
    }
    url = 'https://tc-tct.douyucdn2.cn/dyliveflv3a/%s%s.flv'%(room_id,val)
    print url
    os.system('wget %s'%url)
